package com.ylz.ai.auth.server.modules.user.config;

import com.ylz.ai.auth.server.configuration.KeyConfiguration;
import com.ylz.ai.auth.server.configuration.UserConfiguration;
import com.ylz.ai.auth.server.constant.RedisKeyConstant;
import com.ylz.ai.auth.server.modules.user.exception.AuthExceptionEntryPoint;
import com.ylz.ai.auth.server.modules.user.filter.IntegrationAuthenticationFilter;
import com.ylz.ai.auth.server.modules.user.service.IntegrationUserDetailsService;
import com.ylz.ai.auth.server.modules.user.vo.OauthUser;
import com.ylz.ai.common.constant.JwtKeyConstants;
import com.ylz.ai.common.encoder.Sha256PasswordEncoder;
import com.ylz.ai.common.util.AesUtils;
import com.ylz.ai.common.util.EncoderUtils;
import com.ylz.ai.common.util.LocalDateTimeUtils;
import com.ylz.ai.common.util.RsaKeyUtils;
