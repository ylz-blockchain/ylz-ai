package com.ylz.ai.auth.server.modules.user.authenticator.impl;

import com.ylz.ai.auth.server.auth.client.ClientTokenHelper;
import com.ylz.ai.auth.server.configuration.ClientConfiguration;
import com.ylz.ai.auth.server.feign.IUserFeign;
import com.ylz.ai.auth.server.modules.user.authenticator.AbstractPrepareIntegrationAuthenticator;
...
import com.ylz.ai.common.exception.auth.ClientInvalidException;
