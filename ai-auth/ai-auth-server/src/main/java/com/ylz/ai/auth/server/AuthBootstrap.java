package com.ylz.ai.auth.server;
...
@Slf4j
@SpringBootApplication(scanBasePackages = {"com.ylz.ai.auth.server", "com.ylz.ai.common"})
@EnableFeignClients({"com.ylz.ai.auth.server.feign"})
